...
import {MarketTradingData, Side, MarketOrderType} from "../src/interfaces/Types.sol";
 ...
 * @notice Tests market-pause enforcement across all trading paths
 *         (limit orders, matching, market orders, split/merge).
 *         Protocol-pause and venue-suspension have been removed from
 *         ProtocolFacet (v1.4.0); those tests were dropped with the
